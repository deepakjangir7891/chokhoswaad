              ...
              <div class="flex flex-wrap -mx-3">
                ...
                <div
                  ...
                  <div
                    ...
                    <img
                      src="{{asset('admin/img/shapes/waves-white.svg')}}"
                    ...
                    <div
                      ...
                      <img
                        ...
                        src="{{asset('admin/img/illustrations/rocket-white.png')}}"
                        alt="rocket" />
                    </div>
                  </div>
                </div>
        ...
        <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
          <div
            ...
            <div
              ...
              style="background-image: url('{{asset('admin/img/ivancik.jpg')}}">
              <span
                    ...
                    <tr>
                      <td
                        ...
                        <div class="flex px-2 py-1">
                          <div>
                            <img
                              src="{{asset('admin/img/small-logos/logo-xd.svg')}}"
                      ...
                      <td
                        ...
                        <div class="mt-2 avatar-group">
                          <a
                            ...
                            <img
                              src="{{asset('admin/img/team-1.jpg')}}"
                          ...
                          <a
                            ...
                            data-placement="bottom">
                            <img
                              src="{{asset('admin/img/team-2.jpg')}}"
                              class="w-full rounded-full"
                              alt="team2" />
                          </a>
                          <div
                          ...
                          <a
                            ...
                            data-placement="bottom">
                            <img
                              src="{{asset('admin/img/team-3.jpg')}}"
                              class="w-full rounded-full"
                              alt="team3" />
                          </a>
                          <div
                          ...
                          <a
                            ...
                            data-placement="bottom">
                            <img
                              src="{{asset('admin/img/team-4.jpg')}}"
                              class="w-full rounded-full"
                              alt="team4" />
                          </a>
                          <div
                    ...
                    <tr>
                      <td
                        ...
                        <div class="flex px-2 py-1">
                          <div>
                            <img
                              src="{{asset('admin/img/small-logos/logo-atlassian.svg')}}"
                              class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                              alt="atlassian" />
                          </div>
                          <div class="flex flex-col justify-center">
                    ...
                    <tr>
                      <td
                        ...
                        <div class="flex px-2 py-1">
                          <div>
                            <img
                              src="{{asset('admin/img/small-logos/logo-slack.svg')}}"
                              class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                              alt="team7" />
                          </div>
                          <div class="flex flex-col justify-center">
                    ...
                    <tr>
                      <td
                        ...
                        <div class="flex px-2 py-1">
                          <div>
                            <img
                              src="{{asset('admin/img/small-logos/logo-spotify.svg')}}"
                              class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                              alt="spotify" />
                          </div>
                          <div class="flex flex-col justify-center">
                    ...
                    <tr>
                      <td
                        ...
                        <div class="flex px-2 py-1">
                          <div>
                            <img
                              src="{{asset('admin/img/small-logos/logo-jira.svg')}}"
                              class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                              alt="jira" />
                          </div>
                          <div class="flex flex-col justify-center">
                    ...
                    <tr>
                      <td
                        ...
                        <div class="flex px-2 py-1">
                          <div>
                            <img
                              src="{{asset('admin/img/small-logos/logo-invision.svg')}}"
                              class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                              alt="invision" />
                          </div>
                          <div class="flex flex-col justify-center">
