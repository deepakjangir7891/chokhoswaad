...
<section class="owl-carousel img owl-loaded owl-drag" style="background-image: url({{ asset('web/images/bg_2.jpg') }});">

    <div class="slider-item" style="background-image: url({{ asset('web/images/bg_2.jpg') }});">
