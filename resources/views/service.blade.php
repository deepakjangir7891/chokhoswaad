    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 text-center ftco-animate">
                <div class="menu-wrap">
                    <a href="#" class="menu-img img mb-4" style="background-image: url(web/images/images_1/garam_masala.png);"></a>
                    <div class="text">
                        <h3><a href="#">Garam Masala</a></h3>
            ...
            <div class="col-md-3 text-center ftco-animate">
                <div class="menu-wrap">
                    <a href="#" class="menu-img img mb-4" style="background-image: url(web/images/images_1/haldi_powder.png);"></a>
                    <div class="text">
                        <h3><a href="#">Haldi Powder</a></h3>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
                        <p class="price"><span>$2.90</span></p>
                        <p><a href="#" class="btn btn-white btn-outline-white">Add to cart</a></p>
                    </div>
            ...
            <div class="col-md-3 text-center ftco-animate">
                <div class="menu-wrap">
                    <a href="#" class="menu-img img mb-4" style="background-image: url(web/images/images_1/dhaniya_powder.png);"></a>
                    <div class="text">
                        <h3><a href="#">Dhaniya Powder</a></h3>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
                        <p class="price"><span>$2.90</span></p>
                        <p><a href="#" class="btn btn-white btn-outline-white">Add to cart</a></p>
                    </div>
