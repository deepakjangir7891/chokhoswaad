    ...
    <div class="slider-item">
        ...
        <div class="container-fluid">
            <div class="row slider-text align-items-center" data-scrollax-parent="true">
                ...
                <div class="col-md-12 ftco-animate">
                    <img src="{{asset('web/images/images_1/banner_2.png')}}"  class="img-fluid slider-banner" alt="" >
                </div>
    ...
    <div class="slider-item">
        ...
        <div class="container-fluid">
            <div class="row slider-text align-items-center" data-scrollax-parent="true">
                ...
                <div class="col-md-12 ftco-animate">
                    <img src="{{asset('web/images/images_1/banner_3.png')}}"  class="img-fluid slider-banner" alt="" >
                </div>
